...
def parse_qr_data(scanned_url):
    try:
        ...
        # DB占쏙옙占쏙옙 A12 占쌤곤옙占쏙옙 占쏙옙 占쏙옙占쏙옙占싶몌옙 占쏙옙占쏙옙占쏙옙 (FmID 占쏙옙占쏙옙)
        connection = get_db_connection()
        cursor = connection.cursor(pymysql.cursors.DictCursor) # 占쏙옙占쏙옙占?占쏙옙킬訶占쏙옙占?占쌨깍옙
        # [占쏙옙占쏙옙 占쏙옙占쏙옙] WHERE占쏙옙占쏙옙 FmID 占쏙옙占쏙옙占쏙옙 占쌩곤옙占싹울옙 占쏙옙확占쏙옙 占쏙옙占쏙옙占싶몌옙 占쏙옙占쏙옙占쏙옙
        query = f"SELECT * FROM {TABLE_NAME} WHERE Lo = 'A12' AND FmID = %s ORDER BY APC_RT DESC LIMIT 1"
        cursor.execute(query, (fm_id,))
        prev_record = cursor.fetchone()
        connection.close()

        if prev_record:
            # 占쏙옙占쏙옙 占쏙옙占쏙옙占?占쏙옙占쏙옙占쏙옙 占쌔댐옙 占쏙옙占쏙옙占싶몌옙 parsed_data占쏙옙 占쏙옙占쏙옙占쏙옙트
            parsed_data.update(prev_record)
        
        # 占쏙옙占쏙옙 占시곤옙(占쏙옙占쏙옙 占시곤옙)占쏙옙 APC_PT占쏙옙 占쏙옙占?        parsed_data['APC_PT'] = datetime.now().strftime('%Y-%m-%d %H:%M:%S')
        # Lo 占쏙옙占쏙옙 A13占쏙옙占쏙옙 占쌕쏙옙 확占쏙옙占싹곤옙 占쏙옙占쏙옙
        parsed_data['Lo'] = 'A13'
...
def save_to_db(data_dict):
    try:
        ...
        connection.commit()
        print("? A13 占쏙옙占쏙옙占싶곤옙 占쏙옙占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙퓸占쏙옙占쏙옙求占?")
    except Exception as e:
...
if __name__ == "__main__":
    print("?? A13 占쏙옙占쏙옙 占쏙옙캐占쏙옙 占쏙옙占?占쏙옙...")
