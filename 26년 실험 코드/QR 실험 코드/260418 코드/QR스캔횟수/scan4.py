...
# DHT11 占쏙옙占쏙옙 占쏙옙占쏙옙 (GPIO 4占쏙옙 占쏙옙)
...
def read_dht11():
    try:
        # 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙 占싻억옙 占쏙옙占쏙옙占?占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙 占쌍쏙옙占싹댐옙.
        humidity = dht_device.humidity
        temperature = dht_device.temperature
        if humidity is not None and temperature is not None:
            print(f"DHT11 Read: Temp={temperature}占쏙옙C, Humidity={humidity}%")
            return humidity, temperature
    except RuntimeError as error:
        # DHT 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占싻깍옙 占쏙옙占쏙옙占쏙옙 占쌩삼옙占쏙옙 占쏙옙 占쌍쏙옙占싹댐옙.
        print(f"Error reading DHT11 sensor: {error.args[0]}")
    except Exception as e:
        print(f"An unexpected error occurred with DHT11: {e}")
    return None, None
...
def parse_qr_data(scanned_url):
    try:
        ...
        # A14 占쌤계에占쏙옙占쏙옙 FmID占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙占싶몌옙 占쏙옙회占싹몌옙 占쏙옙占쏙옙爛求占?
        parsed_data = {'Lo': 'A14', 'FmID': fm_id}

        connection = get_db_connection()
        cursor = connection.cursor(pymysql.cursors.DictCursor)
        # [占쏙옙占쏙옙 占쏙옙占쏙옙] WHERE占쏙옙占쏙옙 FmID 占쏙옙占쏙옙占쏙옙 占쌩곤옙占싹울옙 占쏙옙확占쏙옙 占쏙옙占쏙옙占싶몌옙 占쏙옙占쏙옙占쏙옙
        query = f"SELECT * FROM {TABLE_NAME} WHERE Lo = 'A13' AND FmID = %s ORDER BY APC_PT DESC LIMIT 1"
        ...
        # 占쏙옙占쏙옙 占시곤옙(창占쏙옙 占쌉곤옙 占시곤옙)占쏙옙 APC_StD占쏙옙 占쏙옙占?        parsed_data['APC_StD'] = datetime.now().strftime('%Y-%m-%d %H:%M:%S')
        parsed_data['Lo'] = 'A14'
...
def save_to_db(data_dict):
    try:
        ...
        # GPS 占쏙옙 DHT11 占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占싻깍옙
        lat, lon = read_gps_data()
        humidity, temperature = read_dht11()
        data_dict['Lat'] = lat
        data_dict['lon'] = lon
        data_dict['Tp'] = temperature
        data_dict['Hm'] = humidity
        ...
        connection.commit()
        print("? A14 占쏙옙占쏙옙占싶곤옙 占쏙옙占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙퓸占쏙옙占쏙옙求占?")
    except Exception as e:
...
if __name__ == "__main__":
    print("?? A14 창占쏙옙 占쌉곤옙 占쏙옙캐占쏙옙 占쏙옙占?占쏙옙...")
